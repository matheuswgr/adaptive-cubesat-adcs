...
int main()
{
    ...
    std::cout << slidingController.UpdateControlSignal(slidingVariable,satelliteVelocity,reactionWheelVelocities,attitude,referenceAttitude.conjugate()*attitude) << "\n\n";
}