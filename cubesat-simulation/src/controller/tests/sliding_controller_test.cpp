...
int main()
{
    ...
    SlidingControllerSystem controlSystem(slidingController, satelliteModel, kalmanFilter);
    ...
    std::cout << controlSystem.filteredSatelliteVelocity << "\n\n";
    std::cout << controlSystem.filteredReactionWheelVelocities << "\n\n";
