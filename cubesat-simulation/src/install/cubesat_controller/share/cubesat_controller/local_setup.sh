...
: ${AMENT_CURRENT_PREFIX:="/home/matheuswagner/repos/adaptive-cubesat-adcs/cubesat-simulation/src/install/cubesat_controller"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/cubesat_controller/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/cubesat_controller/environment/path.sh"
